...
public class FabricEntrypoint implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        BiomeModifications.addSpawn(BiomeSelectors.includeByKey(Biomes.FOREST, Biomes.FLOWER_FOREST, Biomes.BIRCH_FOREST, Biomes.OLD_GROWTH_BIRCH_FOREST, Biomes.CHERRY_GROVE), MobCategory.CREATURE, KiwiModEntities.KIWI.get(), 20, 3, 4);
